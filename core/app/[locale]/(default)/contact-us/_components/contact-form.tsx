    ...
    <>
      ...
      <div className="container mx-auto px-4 py-16">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <a href="tel:01618706350" className="my-1 block text-xl font-bold text-orange-600 hover:underline">
                    0161 870 6350
                  </a>
        ...
        <div className="mt-8 flex items-center justify-center gap-2 text-center text-sm text-slate-500">
          ...
          <span>WeWork - Dalton Place | 29 John Dalton St | Manchester | M2 6DS</span>
        </div>
      </div>
    </>
  );
